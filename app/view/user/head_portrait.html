<div class="uploadImg_box uploadImg_box-open">
    <div class="userInfo_box_uploadImg">
        <div class="userInfo_box_uploadImg_content">
            ...
            <div class="userInfo_box_uploadImg_content_mian">
                <div class="userInfo_box_uploadImg_content_mian_left fl">
                    <div class="userInfo_box_uploadImg_content_mian_left_imgBox">
                        <!-- 这是初始图片 -->
                        <img src="__STATIC__/libs/head_portrait/img/user_unSet_image.png" id="image">
                    </div>
            ...
            <div class="userInfo_box_uploadImg_toolbar">
                <label id="userImg_noSave" class="curp">取&nbsp;&nbsp;消</label>
...
<script>
    $(function () {
        ...
        var originalImageURL = '__STATIC__/libs/head_portrait/img/user_unSet_image.png';
        ...
        $save.on('click', function () {
            ...
            $('#image').cropper('getCroppedCanvas').toBlob(function (blob) {
                ...
                formData.append('photoFile', blob,'tmp.png');
                $.ajax({
                    url: '{:url("index/User/uploadImg")}',
                    method: "POST",
                    headers: {
        ...
        $('.user-box-info-img').click(function () {
            $(".uploadImg_box").fadeIn();
            $(".userInfo_box_uploadImg").animate({top:'50%'});
        });

        $("#userImg_noSave").click(function () {
            $(".uploadImg_box").fadeOut();
            $(".userInfo_box_uploadImg").animate({top:'40%'});
        });

        /*$(".uploadImg_box").click(function () {
            $(".uploadImg_box").fadeOut();
            $(".userInfo_box_uploadImg").animate({top:'40%'});
        });

        $('.userInfo_box_uploadImg').click(function () {
            return false;
        })*/
